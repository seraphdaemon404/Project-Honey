...
public class CharacterMotor : MonoBehaviour
{
	...
	public class CharacterMotorMovement
	{
		...
		[System.NonSerialized]
		public Vector3 fVelocity = Vector3.zero;
	...
	private void UpdateFunction()
	{
		...
		// Move our character!
		movement.cflags = controller.Move(currentMovementOffset);
	...
	void OnControllerColliderHit(ControllerColliderHit hit)
	{
		if (hit.normal.y > 0 && hit.normal.y > groundNormal.y && hit.moveDirection.y < 0)
		{
			...
			movement.fVelocity = Vector3.zero;
		}
	}
	...
	{
		return (movement.cflags & CollisionFlags.CollidedAbove) != 0;
	}
	...
	float MaxSpeedInDirection(Vector3 desiredMovementDirection)
	{
		...
		else
		{
			...
			{
				 zAxisEllipseMultiplier = movement.maxForwardSpeed;
			}
